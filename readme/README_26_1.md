...
1. https://stripe.com/docs/api/products/create — создание продукта;
2. https://stripe.com/docs/api/prices/create — создание цены;
3. https://stripe.com/docs/api/checkout/sessions/create — создание сессии для получения ссылки на оплату.
