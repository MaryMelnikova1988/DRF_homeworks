...
class LessonAPITestCase(APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create(email="test2@sky.pro")
    ...
    def test_list_lesson(self):
        ...
        response = self.client.get(
            reverse('online_studing:lesson_list')
        )
    ...
    def test_get_lesson(self):
        ...
        response = self.client.get(
            reverse('online_studing:lesson_get', kwargs={'pk': self.lesson.id})
        )
    ...
    def test_create_lesson(self):
        ...
        response = self.client.post(
            reverse('online_studing:lesson_create'),
            data=data
        )
    ...
    def test_update_lesson(self):
        ...
        response = self.client.patch(
            reverse('online_studing:lesson_update', kwargs={'pk': self.lesson.id}),
            {'description': 'change'})
    ...
    def test_delete_lesson(self):
        ...
        response = self.client.delete(
            reverse('online_studing:lesson_delete', kwargs={'pk': lesson_del.id}))
...
class SubscriptionAPITestCase(APITestCase):
    ...
    def test_subscribe_to_course(self):
        ...
        response = self.client.post(
            reverse('online_studing:subscription'),
            data=data
        )
